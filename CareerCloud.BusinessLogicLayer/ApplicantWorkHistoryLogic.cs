...
namespace CareerCloud.BusinessLogicLayer
{
    public class ApplicantWorkHistoryLogic : BaseLogic<ApplicantWorkHistoryPoco>
    {
        ...
        public override void Delete(ApplicantWorkHistoryPoco[] pocos)
        {
            base.Delete(pocos);
        }
        ...
        protected override void Verify(ApplicantWorkHistoryPoco[] pocos)
        {
            ...
            foreach(ApplicantWorkHistoryPoco poco in pocos)
            {
                if (poco.CompanyName.Length <= 2)
                    exceptions.Add(new ValidationException(105,$"CompanyName must be greater than 2 characters - {poco.Id}"));
            }
